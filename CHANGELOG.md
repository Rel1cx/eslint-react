...
- refactor(plugins/eslint-plugin): hide `avoid-shorthand-boolean` and `prefer-shorthand-fragment` from presets and docs by @Rel1cx in https://github.com/Rel1cx/eslint-react/pull/876
