  ...
  useNextSeoProps() {
    return match(useRouter())
      .with({ asPath: "/" }, () => ({
        ...
        description: "ESLint x React. A set of ESLint plugins for writing better React.",
      }))
  ...
  head: (
    <>
      ...
      <meta
        ...
        content="ESLint x React. A set of ESLint plugins built for writing better React."
      />
      <link
