...
# Glossary of Terms used in ESLint React

### ESLR

An abbreviation for ESLint React. Also used as the namespace for ESLint React related terms.
...
It's a piece of the UI (user interface) that has its own logic and appearance. A `component` can be as small as a button, or as large as an entire page.
