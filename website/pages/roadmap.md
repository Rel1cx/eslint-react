...
#### Rules in `eslint-plugin-react-dom-a11y` (if port [Svelte's Accessibility warnings](https://svelte.dev/docs/accessibility-warnings))
...
#### Rules in `eslint-plugin-react-dom-a11y` (if port [open-wc's a11y rules](https://open-wc.org/docs/linting/eslint-plugin-lit-a11y/overview/#supported-rules))
