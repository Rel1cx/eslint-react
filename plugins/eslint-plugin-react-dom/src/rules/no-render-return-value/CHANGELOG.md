...
- Calls made through computed string-literal member access (e.g. `obj["render"]()` whose return value is used) are no longer matched, since the runtime property name cannot be statically determined.
