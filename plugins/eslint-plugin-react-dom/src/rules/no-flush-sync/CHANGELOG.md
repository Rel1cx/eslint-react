...
- No longer reports `flushSync` calls made through computed string-literal member access (e.g. `obj["flushSync"]()`), since the runtime property name cannot be statically determined.
