...
- Spread props providing `children` or `dangerouslySetInnerHTML` through a string literal key, a statically evaluable computed key, or an identifier alias chain are now recognized.
