...
- Fixed a false negative where member-expression components (e.g. `<motion.div as="iframe">`) were mistaken for host elements and the polymorphic prop was ignored; they are now resolved through the polymorphic prop and checked like the underlying DOM element.
