...
- No longer reports `findDOMNode` calls made through computed string-literal member access (e.g. `obj["findDOMNode"]()`), since the runtime property name cannot be statically determined.
