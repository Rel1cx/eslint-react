...
- Calls made through computed string-literal member access (e.g. `obj["hydrate"]()`) are no longer matched, since the runtime property name cannot be statically determined.
