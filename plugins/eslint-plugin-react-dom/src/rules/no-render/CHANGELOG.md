...
- Calls made through computed string-literal member access (e.g. `obj["render"]()`) are no longer matched, since the runtime property name cannot be statically determined.
