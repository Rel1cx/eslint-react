...
const finalPlugin: ESLint.Plugin & { configs: Record<ConfigName, Linter.Config> } = {
  ...
  configs: {
     ...
     */
    ["disable-conflict-eslint-plugin-react"]: createConfig(disableConflictEslintPluginReactConfig),
    /**
     * Disable rules in `eslint-plugin-react-hooks` that conflict with rules in this plugin
     */
    ["disable-conflict-eslint-plugin-react-hooks"]: createConfig(disableConflictEslintPluginReactHooksConfig),
    /**
