...
- [Docs Source](https://github.com/Rel1cx/eslint-react/tree/main/plugins/eslint-plugin-react-x/src/rules/set-state-in-render/set-state-in-render.mdx)
- [SPEC Source](https://github.com/Rel1cx/eslint-react/tree/main/plugins/eslint-plugin-react-x/src/rules/set-state-in-render/set-state-in-render.spec.md)
