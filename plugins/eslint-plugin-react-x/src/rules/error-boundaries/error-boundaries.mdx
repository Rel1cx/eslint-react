...
- [Docs Source](https://github.com/Rel1cx/eslint-react/tree/main/plugins/eslint-plugin-react-x/src/rules/error-boundaries/error-boundaries.mdx)
- [SPEC Source](https://github.com/Rel1cx/eslint-react/tree/main/plugins/eslint-plugin-react-x/src/rules/error-boundaries/error-boundaries.spec.md)
