...
- Replaced `isUseRefCall` with `isUseRefLikeCall` when resolving ref init expressions; custom ref hooks matching the `additionalRefHooks` setting are now recognized.
