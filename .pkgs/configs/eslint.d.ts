...
export declare function buildIgnoreConfig(gitignore: string, extra: string[]): readonly [import("@eslint/config-helpers").ConfigObject, import("eslint/config").ConfigObject];
