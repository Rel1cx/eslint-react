 ...
 */
export function getCreateElementTypeArgument(context: RichContext, node: null | TSESTree.Node): TSESTree.CallExpressionArgument | null {
 ...
 */
export function getCreateElementPropsObject(context: RichContext, node: null | TSESTree.Node): TSESTree.ObjectExpression | null {
  if (!isCreateElementCall(context, node)) return null;
 ...
 */
export function getCreateElementChildrenArguments(context: RichContext, node: null | TSESTree.Node): TSESTree.CallExpressionArgument[] {
 ...
 * ```
 */
export function getCreateElementProp(context: RichContext, node: null | TSESTree.Node, name: string): TSESTree.Property | null {
 ...
 */
export function isCreateElementChildrenArgument(context: RichContext, node: TSESTree.Node): boolean {
 ...
 */
export function isInsideCreateElementProps(context: RichContext, node: TSESTree.Node): boolean {
