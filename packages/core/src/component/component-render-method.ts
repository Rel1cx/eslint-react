...
export function isFunctionOfRenderMethod(node: TSESTreeFunction, context: ER.RuleContext) {
 ...
 */
export function isInsideRenderMethod(node: TSESTree.Node, context: ER.RuleContext) {
