...
| <a id="property-directives"></a> `directives` | `Directive`[] | The directives of the function (ex: "use strict", "use client", "use server", etc.) | - | - |
...
| <a id="property-id"></a> `id` | `Node` \| `null` | The identifier of the function | [`SemanticNode`](SemanticNode.md).[`id`](SemanticNode.md#property-id) | - |
...
| <a id="property-name"></a> `name` | `string` \| `null` | The name of the function | [`SemanticNode`](SemanticNode.md).[`name`](SemanticNode.md#property-name) | - |
| <a id="property-node"></a> `node` | `FunctionExpression` | The AST node of the function | [`SemanticNode`](SemanticNode.md).[`node`](SemanticNode.md#property-node) | - |
| <a id="property-parameters"></a> `parameters` | `Parameter`[] | The parameters of the function | - | - |
| <a id="property-type"></a> `type` | `TSTypeAnnotation` \| `null` | The return type annotation of the function | - | - |
| <a id="property-typeparameters"></a> `typeParameters` | `TSTypeParameterDeclaration` \| `null` | The type parameters of the function | - | - |
