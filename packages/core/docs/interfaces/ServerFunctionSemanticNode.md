...
| <a id="property-directives"></a> `directives` | `TSESTreeDirective`[] | The directives of the function (ex: "use strict", "use client", "use server", etc.) | - | [`SemanticFunc`](SemanticFunc.md).[`directives`](SemanticFunc.md#property-directives) |
...
| <a id="property-kind"></a> `kind` | `"server-function"` | The kind of function. | [`SemanticFunc`](SemanticFunc.md).[`kind`](SemanticFunc.md#property-kind) | - |
