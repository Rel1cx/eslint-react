...
| <a id="property-id"></a> ~~`id`~~                   | `BindingName` \| `null`                | The identifier of the class component.            | [`SemanticNode`](SemanticNode.md).[`id`](SemanticNode.md#property-id)     | -                                                                         |
...
| <a id="property-methods"></a> ~~`methods`~~         | `TSESTreeMethodOrPropertyDefinition`[] | The methods of the class component.               | -                                                                         | -                                                                         |
