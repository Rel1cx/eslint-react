[@eslint-react/kit](../README.md) / SemanticNode
...
| <a id="property-id"></a> `id` | `Node` \| `null` | The identifier of the node |
| <a id="property-key"></a> `key` | `string` | The unique key of the node |
| <a id="property-kind"></a> `kind` | `string` | The kind of the node |
| <a id="property-name"></a> `name` | `string` \| `null` | The name of the node |
