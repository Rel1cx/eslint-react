...
- [`Expression`](Expression.md).[`Declaration`](Declaration.md).[`JSDocContainer`](JSDocContainer.md)

## Extended by

- [`InstanceofExpression`](InstanceofExpression.md)
- [`AssignmentExpression`](AssignmentExpression-1.md)
