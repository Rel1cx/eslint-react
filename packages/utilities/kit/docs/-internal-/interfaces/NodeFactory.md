...
> **createAwaitExpression**(`expression`): [`AwaitExpression`](AwaitExpression-1.md)
...
> **createPrivateIdentifier**(`text`): [`PrivateIdentifier`](PrivateIdentifier-1.md)
...
> **updateAwaitExpression**(`node`, `expression`): [`AwaitExpression`](AwaitExpression-1.md)
...
> **updateBinaryExpression**(`node`, `left`, `operator`, `right`): [`BinaryExpression`](BinaryExpression-1.md)
...
> **updateBreakStatement**(`node`, `label`): [`BreakStatement`](BreakStatement-1.md)
...
> **updateCallExpression**(`node`, `expression`, `typeArguments`, `argumentsArray`): [`CallExpression`](CallExpression-1.md)
...
> **updateClassExpression**(`node`, `modifiers`, `name`, `typeParameters`, `heritageClauses`, `members`): [`ClassExpression`](ClassExpression-1.md)
...
> **updateConditionalExpression**(`node`, `condition`, `questionToken`, `whenTrue`, `colonToken`, `whenFalse`): [`ConditionalExpression`](ConditionalExpression-1.md)
...
> **updateContinueStatement**(`node`, `label`): [`ContinueStatement`](ContinueStatement-1.md)
...
> **updateDecorator**(`node`, `expression`): [`Decorator`](Decorator-1.md)
...
> **updateExpressionStatement**(`node`, `expression`): [`ExpressionStatement`](ExpressionStatement-1.md)
...
> **updateForInStatement**(`node`, `initializer`, `expression`, `statement`): [`ForInStatement`](ForInStatement-1.md)
...
> **updateForOfStatement**(`node`, `awaitModifier`, `initializer`, `expression`, `statement`): [`ForOfStatement`](ForOfStatement-1.md)
...
> **updateForStatement**(`node`, `initializer`, `condition`, `incrementor`, `statement`): [`ForStatement`](ForStatement-1.md)
...
> **updateFunctionExpression**(`node`, `modifiers`, `asteriskToken`, `name`, `typeParameters`, `parameters`, `type`, `body`): [`FunctionExpression`](FunctionExpression-1.md)
...
> **updateIfStatement**(`node`, `expression`, `thenStatement`, `elseStatement`): [`IfStatement`](IfStatement-1.md)
...
> **updateImportDeclaration**(`node`, `modifiers`, `importClause`, `moduleSpecifier`, `attributes`): [`ImportDeclaration`](ImportDeclaration-1.md)
...
`undefined` | [`Identifier`](Identifier-1.md) | [`JSDocNamespaceDeclaration`](JSDocNamespaceDeclaration.md)
...
> **updateLabeledStatement**(`node`, `label`, `statement`): [`LabeledStatement`](LabeledStatement-1.md)
...
> **updateMetaProperty**(`node`, `name`): [`MetaProperty`](MetaProperty-1.md)
...
> **updateNewExpression**(`node`, `expression`, `typeArguments`, `argumentsArray`): [`NewExpression`](NewExpression-1.md)
...
> **updateReturnStatement**(`node`, `expression`): [`ReturnStatement`](ReturnStatement-1.md)
...
> **updateSwitchStatement**(`node`, `expression`, `caseBlock`): [`SwitchStatement`](SwitchStatement-1.md)
...
> **updateTaggedTemplateExpression**(`node`, `tag`, `typeArguments`, `template`): [`TaggedTemplateExpression`](TaggedTemplateExpression-1.md)
...
> **updateThrowStatement**(`node`, `expression`): [`ThrowStatement`](ThrowStatement-1.md)
...
> **updateTryStatement**(`node`, `tryBlock`, `catchClause`, `finallyBlock`): [`TryStatement`](TryStatement-1.md)
...
[`Identifier`](Identifier-1.md) | [`ThisTypeNode`](ThisTypeNode.md)
...
> **updateWhileStatement**(`node`, `expression`, `statement`): [`WhileStatement`](WhileStatement-1.md)
...
> **updateWithStatement**(`node`, `expression`, `statement`): [`WithStatement`](WithStatement-1.md)
...
> **updateYieldExpression**(`node`, `asteriskToken`, `expression`): [`YieldExpression`](YieldExpression-1.md)
