...
| `is.componentDecl` | (`node`: `FunctionExpression`, `hint`: `bigint`) => `boolean` | - |
...
| `is.hookDecl` | (`node`: `FunctionExpression` \| `null`) => `boolean` | - |
