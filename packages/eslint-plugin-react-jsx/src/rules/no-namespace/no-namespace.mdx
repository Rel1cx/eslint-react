...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/eslint-plugin-react-jsx/src/rules/no-namespace/no-namespace.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/eslint-plugin-react-jsx/src/rules/no-namespace/no-namespace.spec.ts)
