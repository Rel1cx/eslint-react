[@eslint-react/tools](../README.md) / [Context](../modules/Context.md) / Context

# Interface: Context\<Services\>

[Context](../modules/Context.md).Context
...
- [[TypeId]](Context.Context.md#[typeid])
- [unsafeMap](Context.Context.md#unsafemap)

### Methods

- [[NodeInspectSymbol]](Context.Context.md#[nodeinspectsymbol])
- [[symbol]](Context.Context.md#[symbol])
- [[symbol]](Context.Context.md#[symbol]-1)
- [pipe](Context.Context.md#pipe)
- [toJSON](Context.Context.md#tojson)
- [toString](Context.Context.md#tostring)
...
| Name | Type |
| :------ | :------ |
| `_Services` | `Contravariant`\<`Services`\> |

___

### unsafeMap

• `Readonly` **unsafeMap**: `Map`\<[`Tag`](Context.Tag.md)\<`any`, `any`\>, `any`\>
