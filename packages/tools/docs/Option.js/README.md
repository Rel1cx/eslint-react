...
[@eslint-react/tools](../README.md) / ./Option.js
...
- [getOrThrow](functions/getOrThrow.md)
- [getOrThrowWith](functions/getOrThrowWith.md)
- [getRight](functions/getRight.md)
- [liftNullable](functions/liftNullable.md)
- [liftThrowable](functions/liftThrowable.md)
...
- [OptionUnifyIgnore](interfaces/OptionUnifyIgnore.md)
...
- [flatMapNullable](functions/flatMapNullable.md)
