...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-jsx/src/rules/no-leaked-dollar/no-leaked-dollar.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-jsx/src/rules/no-leaked-dollar/no-leaked-dollar.spec.ts)
