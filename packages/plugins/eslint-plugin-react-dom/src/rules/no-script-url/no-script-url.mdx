...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-dom/src/rules/no-script-url/no-script-url.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-dom/src/rules/no-script-url/no-script-url.spec.ts)
