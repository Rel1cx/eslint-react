...
[![Build with](https://img.shields.io/badge/built_with-tsdown@0.17.3-000000?style=flat)](https://tsdown.dev)
...
Please follow our [contributing guidelines](https://github.com/Rel1cx/eslint-react/tree/naming-convention-use-state-3/.github/CONTRIBUTING.md).

## License

This project is licensed under the MIT License - see the [LICENSE](https://github.com/Rel1cx/eslint-react/tree/naming-convention-use-state-3/LICENSE) file for details.
