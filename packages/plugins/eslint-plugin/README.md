...
[![Build with](https://img.shields.io/badge/built_with-tsdown@0.19.0-000000?style=flat)](https://tsdown.dev)
...
Please follow our [contributing guidelines](https://github.com/Rel1cx/eslint-react/tree/unrun/.github/CONTRIBUTING.md).

## License

This project is licensed under the MIT License - see the [LICENSE](https://github.com/Rel1cx/eslint-react/tree/unrun/LICENSE) file for details.
