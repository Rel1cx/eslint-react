...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-x/src/rules/no-component-will-mount/no-component-will-mount.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-x/src/rules/no-component-will-mount/no-component-will-mount.spec.ts)
