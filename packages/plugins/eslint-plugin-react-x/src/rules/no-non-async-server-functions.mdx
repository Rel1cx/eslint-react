...
```plain copy
@eslint-react/no-non-async-server-functions.spec
```

**Full Name in `eslint-plugin-react-x`**

```plain copy
react-x/no-non-async-server-functions.spec
```
...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-x/src/rules/no-non-async-server-functions.spec.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-x/src/rules/no-non-async-server-functions.spec.spec.ts)
