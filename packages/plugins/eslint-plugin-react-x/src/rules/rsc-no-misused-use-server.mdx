---
title: rsc-no-misused-use-server
---
...
```plain copy
@eslint-react/rsc-no-misused-use-server
```

**Full Name in `eslint-plugin-react-x`**

```plain copy
react-x/rsc-no-misused-use-server
```
...
Checks against misused `'use server'` directive.
...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-x/src/rules/rsc-no-misused-use-server.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-x/src/rules/rsc-no-misused-use-server.spec.ts)
