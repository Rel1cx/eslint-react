...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-x/src/rules/unsupported-syntax/unsupported-syntax.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-x/src/rules/unsupported-syntax/unsupported-syntax.spec.ts)
