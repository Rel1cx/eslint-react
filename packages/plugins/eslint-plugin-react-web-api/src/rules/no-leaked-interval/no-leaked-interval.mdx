...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-web-api/src/rules/no-leaked-interval/no-leaked-interval.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/stable/packages/plugins/eslint-plugin-react-web-api/src/rules/no-leaked-interval/no-leaked-interval.spec.ts)
