...
Reports all JSX elements and fragments in json format. Useful for debugging. This rule should only be used for debugging purposes. Otherwise, leave it off.
