...
```plain copy
@eslint-react/naming-convention/file-name
```

**Full Name in `eslint-plugin-react-naming-convention`**

```plain copy
react-naming-convention/file-name
```
...
export default [
  {
    files: ["**/*.tsx"],
    rules: {
      "@eslint-react/naming-convention/file-name": ["warn", { rule: "PascalCase" }],
    },
  },
];
```
...
src/components/component.tsx
  1:1  error  File name `component.tsx` does not match `PascalCase`. Should rename to `Component.tsx`  @eslint-react/naming-convention/file-name
...
export default [
  {
    files: ["**/*.tsx"],
    rules: {
      "@eslint-react/naming-convention/file-name": ["warn", { rule: "kebab-case" }],
    },
  },
];
```
...
export default [
  ...
  },
  {
    ...
    rules: {
      "@eslint-react/naming-convention/file-name": ["warn", { rule: "camelCase" }],
    },
  },
];
```
...
export default [
  ...
  },
  {
    ...
    files: ["app/**/*.{ts,tsx}"],
    rules: {
      "@eslint-react/naming-convention/file-name": "off",
    },
  },
];
```
...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-naming-convention/src/rules/file-name.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-naming-convention/src/rules/file-name.spec.ts)
