...
| <a id="property-additionalmutablehooks"></a> `additionalMutableHooks` | [`RegExpLike`](../type-aliases/RegExpLike.md)                                  | Regex pattern matching custom hooks that return external mutable stores.    |
| <a id="property-additionalrefhooks"></a> `additionalRefHooks`         | [`RegExpLike`](../type-aliases/RegExpLike.md)                                  | Regex pattern matching custom hooks that should be treated as ref hooks.    |
