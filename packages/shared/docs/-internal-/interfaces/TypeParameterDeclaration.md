...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / TypeParameterDeclaration
...
> `readonly` **parent**: [`InferTypeNode`](InferTypeNode.md) \| [`DeclarationWithTypeParameterChildren`](../type-aliases/DeclarationWithTypeParameterChildren.md)
