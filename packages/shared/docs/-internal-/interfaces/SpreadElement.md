...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / SpreadElement
...
> `readonly` **parent**: [`ArrayLiteralExpression`](ArrayLiteralExpression.md) \| [`CallExpression`](CallExpression.md) \| [`NewExpression`](NewExpression.md)
