...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / DeclarationStatement
...
> `readonly` `optional` **name**: [`StringLiteral`](StringLiteral-1.md) \| [`Identifier`](Identifier-1.md) \| [`NumericLiteral`](NumericLiteral.md)
