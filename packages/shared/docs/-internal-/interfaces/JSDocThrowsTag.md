...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / JSDocThrowsTag

# Interface: JSDocThrowsTag
...
> `readonly` **kind**: [`JSDocThrowsTag`](../enumerations/SyntaxKind.md#jsdocthrowstag)
