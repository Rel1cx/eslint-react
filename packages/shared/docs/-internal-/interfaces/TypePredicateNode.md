...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / TypePredicateNode
...
> `readonly` **parameterName**: [`Identifier`](Identifier-1.md) \| [`ThisTypeNode`](ThisTypeNode.md)

***

### parent

> `readonly` **parent**: [`JSDocTypeExpression`](JSDocTypeExpression.md) \| [`SignatureDeclaration`](../type-aliases/SignatureDeclaration.md)
