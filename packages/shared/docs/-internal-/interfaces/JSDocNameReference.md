...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / JSDocNameReference
...
> `readonly` **name**: [`EntityName`](../type-aliases/EntityName-1.md) \| [`JSDocMemberName`](JSDocMemberName.md)
