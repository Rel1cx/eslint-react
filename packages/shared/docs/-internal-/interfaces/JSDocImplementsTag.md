...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / JSDocImplementsTag
...
> `readonly` **expression**: [`Identifier`](Identifier-1.md) \| [`PropertyAccessEntityNameExpression`](PropertyAccessEntityNameExpression.md)
