...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / LiteralTypeNode
...
> `readonly` **literal**: [`LiteralExpression`](LiteralExpression.md) \| [`BooleanLiteral`](../type-aliases/BooleanLiteral.md) \| [`PrefixUnaryExpression`](PrefixUnaryExpression.md) \| [`NullLiteral`](NullLiteral-1.md)
