...
> `readonly` **literal**: [`LiteralExpression`](LiteralExpression.md) \| [`BooleanLiteral`](../type-aliases/BooleanLiteral.md) \| [`PrefixUnaryExpression`](PrefixUnaryExpression.md) \| [`NullLiteral`](NullLiteral.md)
