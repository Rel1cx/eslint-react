...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / ClassStaticBlockDeclaration
...
> `readonly` **parent**: [`ClassDeclaration`](ClassDeclaration.md) \| [`ClassExpression`](ClassExpression-1.md)
