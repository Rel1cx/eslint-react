...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / JsxTagNamePropertyAccess
...
> `readonly` **expression**: [`Identifier`](Identifier.md) \| [`ThisExpression`](ThisExpression.md) \| [`JsxTagNamePropertyAccess`](JsxTagNamePropertyAccess.md)
