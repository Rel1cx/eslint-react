...
> **AssignmentExpression**: [`BinaryExpression`](BinaryExpression.md)

***

### AssignmentPattern

> **AssignmentPattern**: [`BinaryExpression`](BinaryExpression.md) \| [`BindingElement`](BindingElement.md) \| [`ParameterDeclaration`](ParameterDeclaration.md) \| [`ShorthandPropertyAssignment`](ShorthandPropertyAssignment.md)

***

### AwaitExpression

> **AwaitExpression**: [`AwaitExpression`](AwaitExpression.md)

***

### BinaryExpression

> **BinaryExpression**: [`BinaryExpression`](BinaryExpression.md)
...
> **BreakStatement**: [`BreakStatement`](BreakStatement.md)

***

### CallExpression

> **CallExpression**: [`CallExpression`](CallExpression.md)
...
> **ChainExpression**: [`CallExpression`](CallExpression.md) \| [`ElementAccessExpression`](ElementAccessExpression.md) \| [`NonNullExpression`](NonNullExpression.md) \| [`PropertyAccessExpression`](PropertyAccessExpression.md)

***

### ClassBody

> **ClassBody**: [`ClassDeclaration`](ClassDeclaration.md) \| [`ClassExpression`](ClassExpression.md)
...
> **ClassExpression**: [`ClassExpression`](ClassExpression.md)

***

### ConditionalExpression

> **ConditionalExpression**: [`ConditionalExpression`](ConditionalExpression.md)

***

### ContinueStatement

> **ContinueStatement**: [`ContinueStatement`](ContinueStatement.md)

***

### DebuggerStatement

> **DebuggerStatement**: [`DebuggerStatement`](DebuggerStatement.md)
...
> **EmptyStatement**: [`EmptyStatement`](EmptyStatement.md)
...
> **ExportDefaultDeclaration**: [`ClassDeclaration`](ClassDeclaration.md) \| [`ClassExpression`](ClassExpression.md) \| [`EnumDeclaration`](EnumDeclaration.md) \| [`ExportAssignment`](ExportAssignment.md) \| [`FunctionDeclaration`](FunctionDeclaration.md) \| [`InterfaceDeclaration`](InterfaceDeclaration.md) \| [`ModuleDeclaration`](ModuleDeclaration.md) \| [`TypeAliasDeclaration`](TypeAliasDeclaration.md) \| [`VariableStatement`](VariableStatement.md)

***

### ExportNamedDeclaration

> **ExportNamedDeclaration**: [`ClassDeclaration`](ClassDeclaration.md) \| [`ClassExpression`](ClassExpression.md) \| [`EnumDeclaration`](EnumDeclaration.md) \| [`ExportDeclaration`](ExportDeclaration.md) \| [`FunctionDeclaration`](FunctionDeclaration.md) \| [`ImportEqualsDeclaration`](ImportEqualsDeclaration.md) \| [`InterfaceDeclaration`](InterfaceDeclaration.md) \| [`ModuleDeclaration`](ModuleDeclaration.md) \| [`TypeAliasDeclaration`](TypeAliasDeclaration.md) \| [`VariableStatement`](VariableStatement.md)
...
> **ExpressionStatement**: [`ExpressionStatement`](ExpressionStatement.md)

***

### ForInStatement

> **ForInStatement**: [`ForInStatement`](ForInStatement.md)

***

### ForOfStatement

> **ForOfStatement**: [`ForOfStatement`](ForOfStatement.md)

***

### ForStatement

> **ForStatement**: [`ForStatement`](ForStatement.md)
...
> **FunctionExpression**: [`ConstructorDeclaration`](ConstructorDeclaration.md) \| [`FunctionExpression`](FunctionExpression.md) \| [`GetAccessorDeclaration`](GetAccessorDeclaration.md) \| [`MethodDeclaration`](MethodDeclaration.md) \| [`SetAccessorDeclaration`](SetAccessorDeclaration.md)

***

### Identifier

> **Identifier**: [`ConstructorDeclaration`](ConstructorDeclaration.md) \| [`Identifier`](Identifier.md) \| [`Token`](Token.md)\<[`ImportKeyword`](../enumerations/SyntaxKind.md#importkeyword) \| [`NewKeyword`](../enumerations/SyntaxKind.md#newkeyword)\>

***

### IfStatement

> **IfStatement**: [`IfStatement`](IfStatement.md)
...
> **ImportDeclaration**: [`ImportDeclaration`](ImportDeclaration.md)
...
> **ImportExpression**: [`CallExpression`](CallExpression.md)
...
> **JSXIdentifier**: [`Identifier`](Identifier.md) \| [`ThisExpression`](ThisExpression.md)
...
> **LabeledStatement**: [`LabeledStatement`](LabeledStatement.md)

***

### Literal

> **Literal**: [`StringLiteral`](StringLiteral.md) \| [`BigIntLiteral`](BigIntLiteral.md) \| [`BooleanLiteral`](../type-aliases/BooleanLiteral.md) \| [`NullLiteral`](NullLiteral.md) \| [`NumericLiteral`](NumericLiteral.md) \| [`RegularExpressionLiteral`](RegularExpressionLiteral.md)

***

### LogicalExpression

> **LogicalExpression**: [`BinaryExpression`](BinaryExpression.md)
...
> **MetaProperty**: [`MetaProperty`](MetaProperty.md)
...
> **NewExpression**: [`NewExpression`](NewExpression.md)
...
> **PrivateIdentifier**: [`PrivateIdentifier`](PrivateIdentifier.md)
...
> **ReturnStatement**: [`ReturnStatement`](ReturnStatement.md)

***

### SequenceExpression

> **SequenceExpression**: [`BinaryExpression`](BinaryExpression.md)
...
> **TaggedTemplateExpression**: [`TaggedTemplateExpression`](TaggedTemplateExpression.md)
...
> **ThisExpression**: [`Identifier`](Identifier.md) \| [`ThisExpression`](ThisExpression.md) \| [`KeywordTypeNode`](KeywordTypeNode.md)\<[`KeywordTypeSyntaxKind`](../type-aliases/KeywordTypeSyntaxKind.md)\>

***

### ThrowStatement

> **ThrowStatement**: [`ThrowStatement`](ThrowStatement.md)

***

### TryStatement

> **TryStatement**: [`TryStatement`](TryStatement.md)
...
> **TSAbstractMethodDefinition**: [`ConstructorDeclaration`](ConstructorDeclaration.md) \| [`GetAccessorDeclaration`](GetAccessorDeclaration.md) \| [`MethodDeclaration`](MethodDeclaration.md) \| [`SetAccessorDeclaration`](SetAccessorDeclaration.md)
...
> **TSEmptyBodyFunctionExpression**: [`ConstructorDeclaration`](ConstructorDeclaration.md) \| [`FunctionExpression`](FunctionExpression.md) \| [`GetAccessorDeclaration`](GetAccessorDeclaration.md) \| [`MethodDeclaration`](MethodDeclaration.md) \| [`SetAccessorDeclaration`](SetAccessorDeclaration.md)
...
> **TSEnumDeclaration**: [`EnumDeclaration`](EnumDeclaration.md)
...
> **TSIndexSignature**: [`IndexSignatureDeclaration`](IndexSignatureDeclaration.md)
...
> **TSNullKeyword**: [`NullLiteral`](NullLiteral.md) \| [`KeywordTypeNode`](KeywordTypeNode.md)\<[`KeywordTypeSyntaxKind`](../type-aliases/KeywordTypeSyntaxKind.md)\>
...
> **TSQualifiedName**: [`Identifier`](Identifier.md) \| [`QualifiedName`](QualifiedName.md)

***

### TSReadonlyKeyword

> **TSReadonlyKeyword**: [`Token`](Token.md)\<[`ReadonlyKeyword`](../enumerations/SyntaxKind.md#readonlykeyword)\>
...
> **TSTypeAliasDeclaration**: [`TypeAliasDeclaration`](TypeAliasDeclaration.md)
...
> **TSTypeParameterInstantiation**: [`CallExpression`](CallExpression.md) \| [`ExpressionWithTypeArguments`](ExpressionWithTypeArguments.md) \| [`ImportTypeNode`](ImportTypeNode.md) \| [`JsxOpeningElement`](JsxOpeningElement.md) \| [`JsxSelfClosingElement`](JsxSelfClosingElement.md) \| [`NewExpression`](NewExpression.md) \| [`TaggedTemplateExpression`](TaggedTemplateExpression.md) \| [`TypeQueryNode`](TypeQueryNode.md) \| [`TypeReferenceNode`](TypeReferenceNode.md)
...
> **WhileStatement**: [`WhileStatement`](WhileStatement.md)

***

### WithStatement

> **WithStatement**: [`WithStatement`](WithStatement.md)

***

### YieldExpression

> **YieldExpression**: [`YieldExpression`](YieldExpression.md)
