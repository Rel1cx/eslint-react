...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / BindingElement
...
> `readonly` **name**: [`BindingName`](../type-aliases/BindingName-1.md)
...
> `readonly` **parent**: [`BindingPattern`](../type-aliases/BindingPattern-1.md)
