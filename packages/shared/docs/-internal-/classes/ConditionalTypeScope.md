...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / ConditionalTypeScope
...
> **new ConditionalTypeScope**(`scopeManager`, `upperScope`, `block`): [`ConditionalTypeScope`](ConditionalTypeScope.md)
