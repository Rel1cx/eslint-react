...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / TSModuleScope

# Class: TSModuleScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`tsModule`](../README.md#tsmodule), [`TSModuleDeclaration`](../type-aliases/TSModuleDeclaration.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new TSModuleScope()

> **new TSModuleScope**(`scopeManager`, `upperScope`, `block`): [`TSModuleScope`](TSModuleScope.md)
...
> `readonly` **block**: [`TSModuleDeclaration`](../type-aliases/TSModuleDeclaration.md)
...
> `readonly` **type**: [`tsModule`](../README.md#tsmodule)
