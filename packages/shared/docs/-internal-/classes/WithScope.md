...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / WithScope

# Class: WithScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`with`](../README.md#with), [`WithStatement`](../interfaces/WithStatement.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new WithScope()

> **new WithScope**(`scopeManager`, `upperScope`, `block`): [`WithScope`](WithScope.md)
...
> `readonly` **block**: [`WithStatement`](../interfaces/WithStatement.md)
...
> `readonly` **type**: [`with`](../README.md#with)
