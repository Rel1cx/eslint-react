...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / ClassScope

# Class: ClassScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`class`](../README.md#class), [`ClassDeclaration`](../type-aliases/ClassDeclaration.md) \| [`ClassExpression`](../interfaces/ClassExpression.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new ClassScope()

> **new ClassScope**(`scopeManager`, `upperScope`, `block`): [`ClassScope`](ClassScope.md)
...
> `readonly` **block**: [`ClassDeclaration`](../type-aliases/ClassDeclaration.md) \| [`ClassExpression`](../interfaces/ClassExpression.md)
...
> `readonly` **type**: [`class`](../README.md#class)
