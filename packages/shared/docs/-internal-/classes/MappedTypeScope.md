...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / MappedTypeScope

# Class: MappedTypeScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`mappedType`](../README.md#mappedtype), [`TSMappedType`](../interfaces/TSMappedType.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new MappedTypeScope()

> **new MappedTypeScope**(`scopeManager`, `upperScope`, `block`): [`MappedTypeScope`](MappedTypeScope.md)
...
> `readonly` **block**: [`TSMappedType`](../interfaces/TSMappedType.md)
...
> `readonly` **type**: [`mappedType`](../README.md#mappedtype)
