...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / ClassStaticBlockScope

# Class: ClassStaticBlockScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`classStaticBlock`](../README.md#classstaticblock), `TSESTree.StaticBlock`, [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new ClassStaticBlockScope()

> **new ClassStaticBlockScope**(`scopeManager`, `upperScope`, `block`): [`ClassStaticBlockScope`](ClassStaticBlockScope.md)
...
> `readonly` **type**: [`classStaticBlock`](../README.md#classstaticblock)
