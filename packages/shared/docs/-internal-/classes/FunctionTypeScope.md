...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / FunctionTypeScope
...
> **new FunctionTypeScope**(`scopeManager`, `upperScope`, `block`): [`FunctionTypeScope`](FunctionTypeScope.md)
