...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / TSEnumScope

# Class: TSEnumScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`tsEnum`](../README.md#tsenum), [`TSEnumDeclaration`](../interfaces/TSEnumDeclaration.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new TSEnumScope()

> **new TSEnumScope**(`scopeManager`, `upperScope`, `block`): [`TSEnumScope`](TSEnumScope.md)
...
> `readonly` **block**: [`TSEnumDeclaration`](../interfaces/TSEnumDeclaration.md)
...
> `readonly` **type**: [`tsEnum`](../README.md#tsenum)
