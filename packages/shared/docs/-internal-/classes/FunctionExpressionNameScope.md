...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / FunctionExpressionNameScope

# Class: FunctionExpressionNameScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`functionExpressionName`](../README.md#functionexpressionname), [`FunctionExpression`](../interfaces/FunctionExpression.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new FunctionExpressionNameScope()

> **new FunctionExpressionNameScope**(`scopeManager`, `upperScope`, `block`): [`FunctionExpressionNameScope`](FunctionExpressionNameScope.md)
...
> `readonly` **block**: [`FunctionExpression`](../interfaces/FunctionExpression.md)
...
> `readonly` **type**: [`functionExpressionName`](../README.md#functionexpressionname)
