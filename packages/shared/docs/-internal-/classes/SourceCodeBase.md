...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / SourceCodeBase
...
> **new SourceCodeBase**(`text`, `ast`): [`SourceCodeBase`](SourceCodeBase.md)
...
[`TokenStore`](TokenStore.md).[`constructor`](TokenStore.md#constructors)

### new SourceCodeBase()

> **new SourceCodeBase**(`config`): [`SourceCodeBase`](SourceCodeBase.md)
...
[`TokenStore`](TokenStore.md).[`getTokensAfter`](TokenStore.md#gettokensafter)
