...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / TypeScope

# Class: TypeScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`type`](../README.md#type), [`TSInterfaceDeclaration`](../interfaces/TSInterfaceDeclaration.md) \| [`TSTypeAliasDeclaration`](../interfaces/TSTypeAliasDeclaration.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new TypeScope()

> **new TypeScope**(`scopeManager`, `upperScope`, `block`): [`TypeScope`](TypeScope.md)
...
> `readonly` **block**: [`TSInterfaceDeclaration`](../interfaces/TSInterfaceDeclaration.md) \| [`TSTypeAliasDeclaration`](../interfaces/TSTypeAliasDeclaration.md)
...
> `readonly` **type**: [`type`](../README.md#type)
