...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / SwitchScope

# Class: SwitchScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`switch`](../README.md#switch), [`SwitchStatement`](../interfaces/SwitchStatement.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new SwitchScope()

> **new SwitchScope**(`scopeManager`, `upperScope`, `block`): [`SwitchScope`](SwitchScope.md)
...
> `readonly` **block**: [`SwitchStatement`](../interfaces/SwitchStatement.md)
...
> `readonly` **type**: [`switch`](../README.md#switch)
