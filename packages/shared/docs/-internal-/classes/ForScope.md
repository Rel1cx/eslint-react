...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / ForScope

# Class: ForScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`for`](../README.md#for), [`ForInStatement`](../interfaces/ForInStatement.md) \| [`ForOfStatement`](../interfaces/ForOfStatement.md) \| [`ForStatement`](../interfaces/ForStatement.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new ForScope()

> **new ForScope**(`scopeManager`, `upperScope`, `block`): [`ForScope`](ForScope.md)
...
> `readonly` **block**: [`ForInStatement`](../interfaces/ForInStatement.md) \| [`ForOfStatement`](../interfaces/ForOfStatement.md) \| [`ForStatement`](../interfaces/ForStatement.md)
...
> `readonly` **type**: [`for`](../README.md#for)
