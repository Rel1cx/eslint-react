...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / BlockScope

# Class: BlockScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`block`](../README.md#block), [`BlockStatement`](../interfaces/BlockStatement.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new BlockScope()

> **new BlockScope**(`scopeManager`, `upperScope`, `block`): [`BlockScope`](BlockScope.md)
...
> `readonly` **block**: [`BlockStatement`](../interfaces/BlockStatement.md)
...
> `readonly` **type**: [`block`](../README.md#block)
