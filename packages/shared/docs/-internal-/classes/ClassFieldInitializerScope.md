...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / ClassFieldInitializerScope

# Class: ClassFieldInitializerScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`classFieldInitializer`](../README.md#classfieldinitializer), [`Expression`](../type-aliases/Expression.md), [`Scope`](../type-aliases/Scope.md)\>

## Constructors

### new ClassFieldInitializerScope()

> **new ClassFieldInitializerScope**(`scopeManager`, `upperScope`, `block`): [`ClassFieldInitializerScope`](ClassFieldInitializerScope.md)
...
> `readonly` **block**: [`Expression`](../type-aliases/Expression.md)
...
> `readonly` **type**: [`classFieldInitializer`](../README.md#classfieldinitializer)
