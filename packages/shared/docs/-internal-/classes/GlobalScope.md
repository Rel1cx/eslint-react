...
[@eslint-react/shared](../../README.md) / [\<internal\>](../README.md) / GlobalScope

# Class: GlobalScope

## Extends

- [`ScopeBase`](ScopeBase.md)\<[`global`](../README.md#global), `TSESTree.Program`, `null`\>

## Constructors

### new GlobalScope()

> **new GlobalScope**(`scopeManager`, `block`): [`GlobalScope`](GlobalScope.md)
...
> `readonly` **type**: [`global`](../README.md#global)
...
> **defineImplicitVariable**(`name`, `options`): `void`
