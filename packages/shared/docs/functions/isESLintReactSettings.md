...
settings is \{ additionalEffectHooks?: string; additionalMutableHooks?: string; additionalRefHooks?: string; additionalStateHooks?: string; compilationMode?: "infer" \| "annotation" \| "syntax" \| "all"; importSource?: string; polymorphicPropName?: string; version?: string \}
