...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/eslint-plugin-react-x/src/rules/no-unsafe-component-will-update/no-unsafe-component-will-update.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/eslint-plugin-react-x/src/rules/no-unsafe-component-will-update/no-unsafe-component-will-update.spec.ts)
