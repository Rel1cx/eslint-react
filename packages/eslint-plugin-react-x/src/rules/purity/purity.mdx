...
**Full Name in [`eslint-plugin-react-instant@rc`](https://npmx.dev/package/eslint-plugin-react-instant)**
...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/eslint-plugin-react-x/src/rules/purity/purity.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/eslint-plugin-react-x/src/rules/purity/purity.spec.ts)
