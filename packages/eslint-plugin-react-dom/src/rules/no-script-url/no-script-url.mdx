...
- [Rule Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/eslint-plugin-react-dom/src/rules/no-script-url/no-script-url.ts)
- [Test Source](https://github.com/Rel1cx/eslint-react/tree/main/packages/eslint-plugin-react-dom/src/rules/no-script-url/no-script-url.spec.ts)
