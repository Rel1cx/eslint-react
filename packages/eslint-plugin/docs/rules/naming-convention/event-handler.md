...
- `handlerPrefix`: Prefix for component methods used as event handlers. Defaults to `handle`
- `propPrefix`: Prefix for props that are used as event handlers. Defaults to `on`
