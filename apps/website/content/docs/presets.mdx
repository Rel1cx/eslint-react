...
- `recommended`\
  ...
  _This preset includes the `x`, `jsx`, `rsc`, `dom`, `web-api`, and `naming-convention` presets, plus `use-state`._

- `all`\
  Enable all rules in the plugin at their default severities.
