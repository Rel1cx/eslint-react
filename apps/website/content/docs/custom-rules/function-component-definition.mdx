...
- Check whether a component is wrapped in `memo` or `forwardRef` using `kit.flag.component.Memo` / `kit.flag.component.ForwardRef`
- Exclude memoized components by inspecting `component.flag & kit.flag.component.Memo`
