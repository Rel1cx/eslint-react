...
description: ESLint React's toolkit for building custom React rules with JavasSript functions
---
...
type RuleFunction = (ctx: RuleContext, toolkit: RuleToolkit) => RuleListener;
```
