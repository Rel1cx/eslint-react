...
<Callout icon="">
  <BskyPost handle="rel1cx.bsky.social" id="3ltnc77265k2d" />
</Callout>
...
```ts
// Anonymous rule → random hex string name like "a1b2c3d4e5f67890"
...
> **Note:** The rule names are random hex strings generated on each ESLint run. The examples above illustrate the format — actual values will differ every time.
