...
flowchart TB
    ...
    subgraph "Monorepo"
        ...
        subgraph "Packages"
            ...
            subgraph "ESLint Plugins"
                ...
                JSX["eslint-plugin-react-jsx"]:::plugins
                ...
                Debug["eslint-plugin-react-debug"]:::plugins
                Custom["eslint-plugin-react-custom"]:::plugins
    ...
    Core -->|"dependency"| Debug
    Core -->|"dependency"| Custom

    Shared -->|"dependency"| X
    Shared -->|"dependency"| JSX
    Shared -->|"dependency"| RSC
    Shared -->|"dependency"| DOM
    Shared -->|"dependency"| WebAPI
    Shared -->|"dependency"| NamingConvention
    Shared -->|"dependency"| Debug
    Shared -->|"dependency"| Custom
    ...
    Var ---|"provides"| DOM
    Var ---|"provides"| WebAPI
    Var ---|"provides"| NamingConvention
    Var ---|"provides"| Debug

    %% Aggregation of Plugins
    X -->|"aggregated"| Aggregated
    JSX -->|"aggregated"| Aggregated
    ...
    %% Debug and Custom plugins are standalone (not aggregated)
    ...
    click JSX "https://github.com/rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-jsx"
    ...
    click Debug "https://github.com/rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-debug"
    click Custom "https://github.com/rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-custom"
    click RSC "https://github.com/rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-rsc"
...
- **ESLint Plugins**
  ...
  - `packages/plugins/eslint-plugin-react-custom`: Create custom rules with a toolkit that helps identify React patterns
