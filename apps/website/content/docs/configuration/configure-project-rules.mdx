...
<Callout type="info">
  This utility module is for advanced use cases where you need to build custom ESLint rules tailored to your project's specific requirements. For full documentation on the kit module, including API reference and examples, see the [Kit README](https://github.com/Rel1cx/eslint-react/tree/stable/packages/utilities/kit).
</Callout>
