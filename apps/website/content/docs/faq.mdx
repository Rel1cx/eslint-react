  ...
  <Accordion title="What's included?">
    ...
    **Public Packages**
    ...
    - **ESLint Plugins**
      ...
      - [`eslint-plugin-react-jsx`](https://github.com/Rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-jsx) - React Flavored JSX rules.
      - [`eslint-plugin-react-rsc`](https://github.com/Rel1cx/eslint-react/tree/main/packages/plugins/eslint-plugin-react-rsc) - React Server Components rules.
