  ...
  <Accordion title="What's included?">
    ...
    **Public Packages**
    ...
    - **ESLint Plugins**
      ...
      - [`@eslint-react/eslint-plugin`](https://github.com/Rel1cx/eslint-react/tree/main/plugins/@eslint-react/eslint-plugin) - A unified plugin that combines all individual plugins into one.
