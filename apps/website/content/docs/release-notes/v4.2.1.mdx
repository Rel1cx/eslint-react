...
description: "A major release introducing a dedicated JSX plugin, new utility packages for custom rules, and flattened rule naming"
---
...
- **`react-jsx/no-namespace`**: Disallows JSX namespace syntax, as React does not support them.
