...
| [`destructuring-assignment`](https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/destructuring-assignment.md)                           | `prefer-destructuring-assignment` (removed in 5.0.0)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | 🔧          | ❌      |
...
| [`no-unused-state`](https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/no-unused-state.md)                                             | [`no-unused-state`](/docs/rules/no-unused-state) (removed in 5.0.0)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | ✅           | ❌      |
