...
```ts title="rules/checked-requires-onchange-or-readonly.ts"
...
```ts title="rules/forbid-component-props.ts"
import type { RuleDefinition } from "@eslint-react/kit";
...
```ts title="rules/forbid-elements.ts"
import type { RuleDefinition } from "@eslint-react/kit";
...
```ts title="rules/function-component-definition.ts"
import type { RuleDefinition } from "@eslint-react/kit";
...
```ts title="rules/jsx-boolean-value.ts"
import type { RuleDefinition } from "@eslint-react/kit";
...
```ts title="rules/jsx-props-no-spreading.ts"
import type { RuleDefinition } from "@eslint-react/kit";
...
```ts title="rules/no-multi-comp.ts"
import type { RuleDefinition } from "@eslint-react/kit";
import { merge } from "@eslint-react/kit";
...
```ts title="rules/no-unescaped-entities.ts"
import type { RuleDefinition } from "@eslint-react/kit";
