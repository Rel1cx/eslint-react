...
| [`destructuring-assignment`](https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/destructuring-assignment.md)                           | N/A (use `@eslint-react/kit` to implement as a custom rule instead)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 🔧          | ❌      |
...
| [`no-unused-state`](https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/no-unused-state.md)                                             | N/A (Rule deprecated due to low usage and overlap with other rules)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | ✅           | ❌      |
