...
- [Custom Rules For Extended Functionality](/docs/migrating-from-eslint-plugin-react#custom-rules-for-extended-functionality)
...
| [`no-this-in-sfc`](https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/no-this-in-sfc.md)                                               | [`@eslint-react/kit/no-this-in-sfc`](#no-this-in-sfc)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | ✅           | ✅      |
...
## Custom Rules For Extended Functionality
...
You can use [`@eslint-react/kit`](https://github.com/Rel1cx/eslint-react/blob/main/packages/utilities/kit/README.md) to create minimal custom rule implementations directly in your `eslint.config.ts`.
