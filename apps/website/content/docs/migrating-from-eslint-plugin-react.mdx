...
ESLint React is a collection of ESLint plugins and utilities for React, with a focus on performance, TypeScript integration, and alignment with [react.dev](https://react.dev) guidelines. It offers a different set of rules and design choices compared to `eslint-plugin-react`.
