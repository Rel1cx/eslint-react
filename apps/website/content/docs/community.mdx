...
<small>
  _Data collected from [GitHub dependents network](https://github.com/Rel1cx/eslint-react/network/dependents), if there is any mismatch or outdated information, feel free to [open issue](https://github.com/Rel1cx/eslint-react/issues/new?assignees=\&labels=type%3A+documentation\&projects=\&template=docs_report.md\&title=%5Bdocs%5D+) or pull request._
</small>

## Adoption Feedback on Social Media

<Tweet id="2040586505727467641" />
