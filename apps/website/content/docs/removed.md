...
| `react-x/jsx-shorthand-boolean`                              | [`@eslint-react/kit`](https://github.com/Rel1cx/eslint-react/blob/main/packages/utilities/kit/README.md) | 4.0.0      | discontinued |
| `react-x/jsx-shorthand-fragment`                             | [`@eslint-react/kit`](https://github.com/Rel1cx/eslint-react/blob/main/packages/utilities/kit/README.md) | 4.0.0      | discontinued |
...
| `react-x/no-default-props`                                   | [`@eslint-react/kit/no-default-props`](/docs/packages/kit)                                               | 2.9.3      | deprecated   |
| `react-x/no-forbidden-props`                                 | [`@eslint-react/kit/no-forbidden-props`](/docs/packages/kit)                                             | 2.3.2      | deprecated   |
...
| `react-x/no-prop-types`                                      | [`@eslint-react/kit/no-prop-types`](/docs/packages/kit)                                                  | 2.9.3      | deprecated   |
| `react-x/no-string-refs`                                     | [`@eslint-react/kit/no-string-refs`](/docs/packages/kit)                                                 | 2.9.3      | deprecated   |
