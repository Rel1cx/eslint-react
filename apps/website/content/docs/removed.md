...
| `react-x/jsx-shorthand-boolean`                              | [`react-custom/<rule-name>`](https://github.com/Rel1cx/eslint-react/blob/main/packages/plugins/eslint-plugin-react-custom/README.md) | 4.0.0      | discontinued |
| `react-x/jsx-shorthand-fragment`                             | [`react-custom/<rule-name>`](https://github.com/Rel1cx/eslint-react/blob/main/packages/plugins/eslint-plugin-react-custom/README.md) | 4.0.0      | discontinued |
