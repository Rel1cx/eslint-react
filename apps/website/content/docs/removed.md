...
| `react-x/jsx-shorthand-boolean`                              | [`react-kit/<rule-name>`](https://github.com/Rel1cx/eslint-react/blob/main/packages/@eslint-react/kit/README.md) | 4.0.0      | discontinued |
| `react-x/jsx-shorthand-fragment`                             | [`react-kit/<rule-name>`](https://github.com/Rel1cx/eslint-react/blob/main/packages/@eslint-react/kit/README.md) | 4.0.0      | discontinued |
