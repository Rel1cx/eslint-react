...
| `react-x/component-hook-factories`                           | N/A (`eslint-plugin-react-hooks` removed the equivalent rule upstream)                                     | 5.4.0      | upstream removed |
...
| `react-x/no-unnecessary-use-memo`                            | N/A (Rule deprecated due to being inherently incompatible with React Compiler)                             | 5.0.0      | deprecated       |
...
| `react-x/prefer-destructuring-assignment`                    | N/A (Rule deprecated due to low usage; `@eslint-react/kit` can be used to implement a custom rule instead) | 5.0.0      | deprecated       |
| `react-x/prefer-namespace-import`                            | N/A (Rule deprecated due to low usage; `@eslint-react/kit` can be used to implement a custom rule instead) | 5.0.0      | deprecated       |
...
| `react-dom/prefer-namespace-import`                          | N/A (Rule deprecated due to low usage; `@eslint-react/kit` can be used to implement a custom rule instead) | 5.0.0      | deprecated       |
...
| `react-hooks-extra/no-unnecessary-use-callback`              | N/A (Rule deprecated due to being inherently incompatible with React Compiler)                             | 2.0.0      | relocated        |
| `react-hooks-extra/no-unnecessary-use-memo`                  | N/A (Rule deprecated due to being inherently incompatible React Compiler)                                  | 2.0.0      | relocated        |
