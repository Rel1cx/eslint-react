...
| [Destructure Component Props](/docs/recipes/destructure-component-props)     |   1   | Enforces destructuring assignment for component props instead of member expression access.                                                          |
