...
| :----------------------------------------------------------- | :------------------------------------------------------------------------------------------------- | :--------- | :----------- |
| `react-x/avoid-shorthand-boolean`                            | [`react-jsx/shorthand-boolean`](/docs/rules/jsx-shorthand-boolean)                                 | 2.0.0      | consolidated |
| `react-x/avoid-shorthand-fragment`                           | [`react-jsx/shorthand-fragment`](/docs/rules/jsx-shorthand-fragment)                               | 2.0.0      | consolidated |
...
| `react-x/prefer-shorthand-boolean`                           | [`react-jsx/shorthand-boolean`](/docs/rules/jsx-shorthand-boolean)                                 | 2.0.0      | consolidated |
| `react-x/prefer-shorthand-fragment`                          | [`react-jsx/shorthand-fragment`](/docs/rules/jsx-shorthand-fragment)                               | 2.0.0      | consolidated |
...
| `react-jsx/key-before-spread`                                | [`react-jsx/runtime`](/docs/rules/jsx-runtime)                                                     | 4.0.0      | consolidated |
| `react-jsx/no-namespace`                                     | [`react-jsx/runtime`](/docs/rules/jsx-runtime)                                                     | 4.0.0      | consolidated |
