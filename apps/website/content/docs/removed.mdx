...
| `react-naming-convention/filename`                           | [`react-naming-convention/file-name`](/docs/rules/naming-convention-file-name)                                     | 2.12.5     | renamed      |
| `react-naming-convention/filename-extension`                 | [`react-naming-convention/file-name-extension`](/docs/rules/naming-convention-file-name-extension)                 | 2.12.5     | renamed      |
